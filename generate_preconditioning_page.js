    ...
    '@graph': [
      {
        ...
        description:
          'EV battery preconditioning calculator designed to calculate if battery preconditioning saves net highway travel time versus cold-gating penalties.',
      },
      {
        '@type': 'ImageObject',
      ...
      },
      {
        ...
        mainEntity: [
          ...
          {
            '@type': 'Question',
            name: 'Why does the ev battery preconditioning calculator show high energy costs?',
            acceptedAnswer: {
              '@type': 'Answer',
...
console.log('Written app/preconditioning/page.tsx');
