...
import { BatteryCharging, Home, ShieldAlert, Zap, ShieldCheck, Info } from 'lucide-react';
    ...
    <div className="w-full">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 border-t border-slate-800/50">
        <div className="text-center mb-12">
          ...
          <p className="text-slate-400 max-w-3xl mx-auto leading-relaxed">
            Avoid buying expensive diesel generators. Here is how our vehicle to home bidirectional power sizer models continuous home backup and long-term blackout resilience.
          </p>
        </div>
      ...
      <section className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="text-center mb-10">
          ...
          <p className="text-slate-400 max-w-3xl mx-auto leading-relaxed">
            Comparing bidirectional EV backup with noisy fuel generators using our v2h backup duration calculator and our vehicle to home bidirectional power sizer benchmarks.
          </p>
        </div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 border-t border-slate-800/50">
        <div className="text-center mb-12">
          ...
          <p className="text-slate-400 text-sm max-w-2xl mx-auto">
            Practical emergency power insights evaluated across major EV platforms using our v2h backup duration calculator.
          </p>
        </div>
...
console.log('Successfully updated app/v2h-backup/page.tsx without image');
