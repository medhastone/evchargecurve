...
(async () => {
  ...
  await page.goto('http://localhost:3000/curve/tesla-model-y-lr', { waitUntil: 'networkidle0' });
  ...
  // Click EUR in navbar
  // The navbar has a button showing current currency.
  // We need to click it.
  ...
  // Check if EUR symbol is in DcSimulator
  // DcSimulator has an input for kWh cost next to a span with the symbol.
