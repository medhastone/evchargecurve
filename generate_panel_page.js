  ...
  const schemaData = {
    ...
    '@graph': [
      ...
      },
      {
        ...
        image: 'https://evchargecurve.com/images/diagrams/nec-panel-load-calculation-diagram.webp',
      },
      {
        '@type': 'ImageObject',
        url: 'https://evchargecurve.com/images/diagrams/nec-panel-load-calculation-diagram.webp',
        caption:
          'Electrical panel load diagram showing 100A service continuous load calculations for installing a 32A vs 48A EV charger breaker',
        width: 1200,
        height: 630,
      },
      {
    ...
    <div className="w-full">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-12 pb-8 md:pt-20 md:pb-12 text-center">
        ...
        <p className="text-sm text-emerald-400/90 max-w-3xl mx-auto font-medium flex items-center justify-center gap-2 bg-emerald-500/10 py-2.5 px-5 rounded-full border border-emerald-500/20">
          ...
          <span>Calculations follow NFPA 70 National Electrical Code (NEC) Article 220 load calculation methods and the 80% continuous breaker rule.</span>
        </p>
      </section>
      ...
      <section className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 mb-16">
        <figure className="my-10 rounded-2xl border border-slate-800 bg-[#131B2A] p-4">
          <div className="relative w-full aspect-[1200/630] overflow-hidden rounded-xl bg-slate-900 flex items-center justify-center">
            <Image
              src="/images/diagrams/nec-panel-load-calculation-diagram.webp"
              alt="Electrical panel load diagram showing 100A service continuous load calculations for installing a 32A vs 48A EV charger breaker"
              width={1200}
              height={630}
          ...
          <figcaption className="mt-3 text-center text-xs text-slate-400">
            Figure 2: Load distribution breakdown generated by our ev continuous load calculator nec, illustrating the 80% safety margin on a 100-amp split-phase service.
          </figcaption>
        </figure>
      </section>
...
console.log('Successfully written app/panel-capacity/page.tsx');
